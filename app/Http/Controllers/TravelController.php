...
class TravelController extends Controller
{
    ...
    {
        return view('admin.AllTravel.create',['travelname'=>TravelName::all(),'traveltype'=>BusType::all(),'goingcityname'=>GoingCity::all(),'leavingcityname'=>LeavingCity::all()]);
    }
    ...
    public function store(StoreTravelRequest $request)
    {
        ...
        Travel::create([
            ...
            'bus_type_id'=>	$request->traveltype,
            ...
            'bus_plate_number'=>$request->busno
        ]);
    }catch(Exception $e)  
    {  
    ...
    {
        $travels=Travel::where('slug',$travel)->first();
        return view('admin.AllTravel.edit',['travel'=>$travels,'travelname'=>TravelName::all(),'traveltype'=>BusType::all(),'goingcityname'=>GoingCity::all(),'leavingcityname'=>LeavingCity::all()]);
    }
    ...
    public function update(UpdateTravelRequest $request, $travel)
    {
        try{
            ...
            if(isset($request->image)){
                ...
                $travel->bus_type_id=$request->traveltype;
                ...
                $travel->bus_plate_number=$request->busno;
