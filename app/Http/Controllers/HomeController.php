...
class HomeController extends Controller
{
    ...
    public function adminbashboard(){
        ...
        $countBusType=BusType::count();
        $countBooking=Booking::count();
        return view('admin.index',['travel'=>$countTravel,'user'=>$countUser,'travelname'=>$countTravelName,'bustype'=>$countBusType,'booking'=>$countBooking]);
    }
