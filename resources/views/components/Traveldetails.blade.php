...
<section class="content container">
    ...
    <p>This bus travels from {{$data->leavingcities->city}} to {{$data->goingcities->city}}.These bus offered by state road transport corporations as well as private bus operators and bus travel companies.It consist of comfortable seats. Hope you enjoy the travels.  </p>
    <hr>
    ...
    <div class="bg-gray p-2 mt-4">
       ...
       @endphp
        ...
        <p><b>Travel Type : {{$data->bustypes->bus_type_name}}</b></p>
        <p><b>Bus Number : {{$data->bus_plate_number}}</b></p>
