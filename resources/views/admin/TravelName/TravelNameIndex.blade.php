...
<div class="container">
    ...
    <div class="d-flex bg-light p-2 justify-content-between">
        ...
        <a href="{{route('travelname.create')}}"><button class="btn btn-primary">Add Travel Name</button></a>
    </div>
    <table id="datatable" class="table">
        <thead>
            ...
            <tr>					
                ...
                <td>
                    <div class="d-flex">
                        <a href="{{route('travelname.edit',['travelname'=>$a->slug])}}"><button class="btn-sm btn-secondary" data-toggle="tooltip" title='Edit Product'>Edit</button></a>
