...
<div class="container">
    ...
    <div class="d-flex bg-light p-2 justify-content-between">
        <h1>All Bus Type</h1>
        <a href="{{route('traveltype.create')}}"><button class="btn btn-primary">Add Bus Type</button></a>
    </div>
    <table id="datatable" class="table">
        <thead>
            ...
            <tr>					
                <td>{{++$index}}</td>
                <td>{{$a->bus_type_name}}</td>
                <td>
                    <div class="d-flex">
                        <a href="{{route('traveltype.edit',['traveltype'=>$a->slug])}}"><button class="btn-sm btn-secondary" data-toggle="tooltip" title='Edit Product'>Edit</button></a>
